...
export default function ChequeEditForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.success) {
        router.push(res.redirect || '/sf/cheque');
        router.refresh();
      } else {
      ...
      <div className="pageheader">
        ...
        <div className="breadcrumb-wrapper">
          ...
          <ol className="breadcrumb">
            ...
            <li><a href="/sf/cheque">Cheque List</a></li>
                ...
                <div className="panel-footer">
                  <div className="row">
                    <div className="col-sm-12 ml_15">
                      ...
                      <button type="button" className="btn btn-default" style={{ marginLeft: '10px' }} onClick={() => router.push('/sf/cheque')}>
                        Cancel
                      </button>
                    </div>
                  </div>
