      ...
      <div className="leftpanel" style={{ minHeight: '100vh' }}>
        ...
        <div className="leftpanelinner">
          <ul className="nav nav-pills nav-stacked nav-bracket">
            ...
            <li className={pathname === '/sf/insurance' ? 'active' : ''}>
              <a href="/sf/insurance">
            ...
            {/* Inquiry Module (id: 3) */}
            {hasAccess('3') && (
              <li className={pathname.startsWith('/sf/inquiry') ? 'active' : ''}>
                <a href="/sf/inquiries">
            ...
            {hasAccess('3') && (
              <li className={pathname.startsWith('/sf/global') ? 'active' : ''}>
                <a href="/sf/global">
            ...
            {hasAccess('3') && (
              <li className={pathname.startsWith('/sf/taken') ? 'active' : ''}>
                <a href="/sf/taken">
            ...
            {/* Renewal Module (id: 3) */}
            {hasAccess('3') && (
              <li className={(pathname.startsWith('/sf/renewal') && !pathname.startsWith('/sf/renewal/reminders')) ? 'active' : ''}>
                <a href="/sf/renewal">
            ...
            {hasAccess('3') && (
              <li className={pathname === '/sf/renewal/reminders' ? 'active' : ''}>
                <a href="/sf/renewal/reminders">
            ...
            {/* Claims Module (id: 8) */}
            {hasAccess('8') && (
              <li className={pathname.startsWith('/sf/claims') ? 'active' : ''}>
                <a href="/sf/claims">
            ...
            {hasAccess('17') && (
              <li className={pathname === '/sf/calculators/one' ? 'active' : ''}>
                <a href="/sf/calculators/one">
            ...
            {hasAccess('18') && (
              <li className={pathname === '/sf/calculators/two' ? 'active' : ''}>
                <a href="/sf/calculators/two">
            ...
            {hasAccess('19') && (
              <li className={pathname === '/sf/calculators/three' ? 'active' : ''}>
                <a href="/sf/calculators/three">
            ...
            <li className={pathname === '/sf/rto' ? 'active' : ''}>
              <a href="/sf/rto">
                <i className="fa fa-home"></i> <span>Dashboard</span>
              </a>
            </li>
            ...
            {/* License Work (id: 6) */}
            {hasAccess('6') && (
              <li className={pathname.startsWith('/sf/license') ? 'active' : ''}>
                <a href="/sf/license">
            ...
            {/* Vahan Work (id: 7) */}
            {hasAccess('7') && (
              <li className={pathname.startsWith('/sf/vahan') ? 'active' : ''}>
                <a href="/sf/vahan">
            ...
            {hasAccess('12') && (
              <li className={pathname.startsWith('/sf/fitness') ? 'active' : ''}>
                <a href="/sf/fitness">
            ...
            {isAdmin && (
              <>
                <li className={pathname.startsWith('/sf/sub-admins') ? 'active' : ''}>
                  <a href="/sf/sub-admins">
                    <i className="fa fa-users"></i> <span>Sub Admins</span>
                  </a>
                </li>
                <li className={pathname.startsWith('/sf/setup/companies') ? 'active' : ''}>
                  <a href="/sf/setup/companies">
                    <i className="fa fa-building"></i> <span>Companies</span>
                  </a>
                </li>
                <li className={pathname.startsWith('/sf/setup/categories') ? 'active' : ''}>
                  <a href="/sf/setup/categories">
                    <i className="fa fa-folder"></i> <span>Categories</span>
                  </a>
                </li>
                <li className={pathname.startsWith('/sf/setup/agents') ? 'active' : ''}>
                  <a href="/sf/setup/agents">
            ...
            {/* Daily Hisab (id: 9) */}
            {hasAccess('9') && (
              <li className={pathname.startsWith('/sf/daily-hisab') ? 'active' : ''}>
                <a href="/sf/daily-hisab">
            ...
            {hasAccess('10') && (
              <li className={pathname.startsWith('/sf/expenses') ? 'active' : ''}>
                <a href="/sf/expenses">
            ...
            {/* Cheque (id: 13) */}
            {hasAccess('13') && (
              <li className={pathname.startsWith('/sf/cheque') ? 'active' : ''}>
                <a href="/sf/cheque">
            ...
            {/* Salary (id: 14) */}
            {hasAccess('14') && (
              <li className={pathname.startsWith('/sf/salary') ? 'active' : ''}>
                <a href="/sf/salary">
            ...
            {/* Ughrani (id: 15) */}
            {hasAccess('15') && (
              <li className={pathname.startsWith('/sf/ughrani') ? 'active' : ''}>
                <a href="/sf/ughrani">
