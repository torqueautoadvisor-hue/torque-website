...
export default function VahanDocumentsClient({
  rtoRecord,
  documents,
  rtoId,
  flag = '',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    formData.append('service_id', '2'); // service_id = 2 (Vahan)
  ...
  const handleDeleteDoc = async (docId: number) => {
    ...
    const res = await deleteRtoDocumentAction(docId, rtoId, 2); // serviceId = 2 (Vahan)
    if (res.success) {
      router.refresh();
      if (res.redirect) router.push(res.redirect);
    } else {
      ...
      <div className="pageheader">
        ...
        <div className="breadcrumb-wrapper">
          ...
          <ol className="breadcrumb">
            ...
            <li><a href="/sf/vahan">Vahan List</a></li>
                ...
                <div className="panel-footer">
                  <div className="row">
                    <div className="col-sm-9 col-sm-offset-3">
                      ...
                      <button type="button" className="btn btn-default" style={{ marginLeft: '10px' }} onClick={() => router.push('/sf/vahan')}>
                        Cancel
                      </button>
                    </div>
                  </div>
