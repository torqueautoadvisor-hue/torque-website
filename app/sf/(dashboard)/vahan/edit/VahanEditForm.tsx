...
export default function VahanEditForm({
  record,
  staffList,
  penResList,
  branchId,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await updateRtoRecord(record.rto_id, 2, formData); // serviceId = 2 (Vahan)
      if (res.success) {
        router.push(res.redirect || '/sf/vahan');
        router.refresh();
      } else {
            ...
            <form onSubmit={handleSubmit} className="form-horizontal">
              <div className="panel panel-default">
                <div className="panel-heading">
                  <h4 className="panel-title">Vahan Details</h4>
                ...
                <div className="panel-body">
                  <div className="form-group col-md-12">
                    <label className="col-sm-3 control-label">Vahan Code <span className="asterisk">*</span></label>
