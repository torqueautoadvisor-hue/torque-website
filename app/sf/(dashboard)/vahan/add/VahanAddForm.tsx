...
export default function VahanAddForm({
  staffList,
  penResList,
  branchId,
  isAdmin,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await createRtoRecord(2, formData); // serviceId = 2 (Vahan)
      if (res.success) {
