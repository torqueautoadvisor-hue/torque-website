...
import { createAgent } from '../../../../../actions/catalog';

export default function AgentAddForm({ statuses }: { statuses: any[] }) {
  ...
  return (
    <div>
      <div className="pageheader">
        <h2><i className="fa fa-plus"></i> Agent</h2>
        <div className="breadcrumb-wrapper">
          ...
          <ol className="breadcrumb">
            ...
            <li className="active">Add Agent</li>
          </ol>
        </div>
      </div>
            ...
            <form onSubmit={handleSubmit}>
              <div className="panel panel-default">
                <div className="panel-heading">
                  <h4 className="panel-title">Add Agent Details</h4>
