...
import { updateCompany } from '../../../../actions/catalog';
...
export default function CompanyEditForm({
  ...
  const [name, setName] = useState(record.cmp_name || '');
  const [status, setStatus] = useState(record.cmp_status ? String(record.cmp_status) : '1');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await updateCompany(record.cmp_id, {
        cmp_name: name,
        cmp_status: status,
      });
  ...
  return (
    <div>
      <div className="pageheader">
        <h2><i className="fa fa-edit"></i> Company</h2>
        <div className="breadcrumb-wrapper">
          <span className="label">You are here:</span>
          <ol className="breadcrumb">
            <li><a style={{ color: '#1C1B17' }} href="/insurance">Dashboard</a></li>
            <li><a style={{ color: '#1C1B17' }} href="/setup/companies">Companies</a></li>
            ...
            <form onSubmit={handleSubmit}>
              <div className="panel panel-default">
                <div className="panel-heading">
                  <h4 className="panel-title">Edit Company Details ({record.cmp_name})</h4>
                ...
                <div className="panel-footer">
                  <div className="row">
                    <div className="col-sm-12 col-lg-12 col-md-12 col-xs-12 ml_15">
                      ...
                      <button type="button" className="btn btn-default" onClick={() => router.push('/setup/companies')} disabled={loading}>
                        Cancel
                      </button>
                    </div>
                  </div>
