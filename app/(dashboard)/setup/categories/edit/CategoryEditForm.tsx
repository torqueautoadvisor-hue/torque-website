...
import { updateCategory } from '../../../../actions/catalog';
...
export default function CategoryEditForm({
  ...
  const [name, setName] = useState(record.ctg_name || '');
  const [status, setStatus] = useState(record.ctg_status ? String(record.ctg_status) : '1');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await updateCategory(record.ctg_id, {
        ctg_name: name,
        ctg_status: status,
      });
  ...
  return (
    <div>
      <div className="pageheader">
        <h2><i className="fa fa-edit"></i> Category</h2>
        <div className="breadcrumb-wrapper">
          <span className="label">You are here:</span>
          <ol className="breadcrumb">
            <li><a style={{ color: '#1C1B17' }} href="/insurance">Dashboard</a></li>
            <li><a style={{ color: '#1C1B17' }} href="/setup/categories">Categories</a></li>
            ...
            <form onSubmit={handleSubmit}>
              <div className="panel panel-default">
                <div className="panel-heading">
                  <h4 className="panel-title">Edit Category Details ({record.ctg_name})</h4>
                ...
                <div className="panel-footer">
                  <div className="row">
                    <div className="col-sm-12 col-lg-12 col-md-12 col-xs-12 ml_15">
                      ...
                      <button type="button" className="btn btn-default" onClick={() => router.push('/setup/categories')} disabled={loading}>
                        Cancel
                      </button>
                    </div>
                  </div>
