...
export default function FitperAddForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.success) {
        router.push(res.redirect || '/fitness');
        router.refresh();
      } else {
      ...
      <div className="pageheader">
        ...
        <div className="breadcrumb-wrapper">
          ...
          <ol className="breadcrumb">
            ...
            <li><a href="/fitness">Fitness & Permit List</a></li>
                ...
                <div className="panel-footer">
                  <div className="row">
                    <div className="col-sm-12 ml_15">
                      ...
                      <button type="button" className="btn btn-default" style={{ marginLeft: '10px' }} onClick={() => router.push('/fitness')}>
                        Cancel
                      </button>
                    </div>
                  </div>
