...
import { createGlobalRecord } from '../../../actions/global';

export default function GlobalAddForm({
  nextGlbCode,
  staffList,
  reasonsList,
  statusList,
  ...
  const [chassis, setChassis] = useState(''); // GVW
  const [engine, setEngine] = useState('');   // Insurance Company
  ...
  const [natPermitDate, setNatPermitDate] = useState('');
  const [taxDate, setTaxDate] = useState('');
  const [qutDate, setQutDate] = useState('');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await createGlobalRecord(payload);
      if (res.success) {
        router.refresh();
  ...
  return (
    <div>
      <div className="pageheader">
        <h2><i className="fa fa-plus"></i> Add Global</h2>
        <div className="breadcrumb-wrapper">
          <span className="label">You are here:</span>
          <ol className="breadcrumb">
            <li><a style={{ color: '#1C1B17' }} href="/insurance">Dashboard</a></li>
            <li><a style={{ color: '#1C1B17' }} href="/global">Global List</a></li>
            <li className="active">Add Global</li>
          </ol>
        </div>
      </div>
            ...
            <form onSubmit={handleSubmit}>
              <div className="panel panel-default">
                <div className="panel-heading">
                  <h4 className="panel-title">Global Details</h4>
                ...
                <div className="panel-body">
                  ...
                  <div className="form-group col-md-12 col-lg-12 col-sm-12 col-xs-12" style={{ marginBottom: '15px' }}>
                    <label className="col-sm-3 control-label">Global Code <span className="asterisk">*</span></label>
                    <div className="col-sm-9">
                      <input type="text" disabled className="form-control" value={nextGlbCode} />
                    </div>
                  </div>
                  ...
                  <div className="form-group col-md-12 col-lg-12 col-sm-12 col-xs-12" style={{ marginBottom: '15px' }}>
                    ...
                    <div className="col-sm-9">
                      ...
                      >
                        ...
                        {/* Add and edit are separated; legacy lets admin change it in edit form */}
                      </select>
                    </div>
                  </div>
                ...
                <div className="panel-footer">
                  <div className="row">
                    <div className="col-sm-12 col-lg-12 col-md-12 col-xs-12 ml_15">
                      ...
                      <button type="button" className="btn btn-default" onClick={() => router.push('/global')} disabled={loading}>
                        Cancel
                      </button>
                    </div>
                  </div>
